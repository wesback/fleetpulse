...
async def lifespan(app: FastAPI):
    ...
    try:
        ...
        # Initialize OpenTelemetry FIRST - before any database operations
        initialize_telemetry()
        ...
        # Initialize database tables - engine will be instrumented when created
        force_recreate = os.environ.get("FORCE_DB_RECREATE", "false").lower() == "true"
        engine = get_engine()  # This will now instrument the engine
